...
{
    public partial class frmArticulosActualizarListaPrecio1 : Form
    {
        public frmArticulosActualizarListaPrecio1()
        {
            InitializeComponent();
        }
            ...
            if (result == System.Windows.Forms.DialogResult.Yes)
            {
                ...
                try
                {
                    foreach (DataGridViewRow row in gridArticulos.Rows)
                    {
                        ...
                        objManejaArticulos.ModificaPrecioL1Masivo(Convert.ToString(row.Cells[0].Value), Convert.ToDecimal(row.Cells[1].Value));
        ...
        private void frmArticulosActualizarListaPrecio1_Load(object sender, EventArgs e)
        {
