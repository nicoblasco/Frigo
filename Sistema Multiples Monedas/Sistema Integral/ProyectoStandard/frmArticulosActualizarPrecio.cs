...
{
    public partial class frmArticulosActualizarPrecio : Form
    {
        public frmArticulosActualizarPrecio()
        {
            InitializeComponent();
        }
        ...
        private void CargoTituloGrilla()
        {
            ...
            gridArticulos.Columns.Add("COSTO", null);//Este es el id extra
        ...
        private void btnProcesar_Click(object sender, EventArgs e)
        {
            ...
            ManejaArticulos objManejaArticulos = new ManejaArticulos();
            message = "¿Esta seguro de que desea actualizar el costo?";
                ...
                try
                  {
                    foreach (DataGridViewRow row in gridArticulos.Rows)
                    {
                            ...
                            objManejaArticulos.ModificaPrecioMasivo (Convert.ToString(row.Cells[0].Value), Convert.ToDecimal(row.Cells[1].Value));
